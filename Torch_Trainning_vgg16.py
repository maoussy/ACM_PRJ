...
model.classifier[-1] = nn.Linear(in_features=4096, out_features=18).to(device)
...
EPOCHS = 50
SAVE_DIR = 'models'
MODEL_SAVE_PATH = os.path.join(SAVE_DIR, 'tsr_vgg16_8_10_6PM.pt')
...
plt.ylabel('Accuracy')
plt.savefig('trainning_vgg16_acc.png', dpi=300)
plt.show()
...
plt.xlabel('Number of epochs')
plt.ylabel('Loss')
plt.savefig('trainning_vgg16_loss.png', dpi=300)
plt.show()
